...
- **`Household`** does **not** declare `Ash.Policy.Authorizer`. It contains no sensitive raw data; computed aggregates are derived from the banking resources above, which are individually policy-guarded.
