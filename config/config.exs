...
# The RELEASE_ROOT guard prevents .env loading when the compiled release is started (Elixir sets
# RELEASE_ROOT at runtime); it does not prevent .env from being sourced during `mix release` compilation.
