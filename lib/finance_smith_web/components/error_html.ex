    ...
    <html lang="en" class="dark">
      ...
      <body class="bg-gray-950 text-gray-100 min-h-screen flex items-center justify-center">
        <main class="text-center max-w-md border border-gray-800 bg-gray-950 p-8 rounded-lg">
          ...
          <h1 class="text-lg font-mono text-emerald-500">There is no data here. Only an anomaly.</h1>
          <p class="mt-4 text-sm text-gray-400 font-mono">The requested resource does not exist.</p>
          <a href="/" class="mt-6 inline-block text-xs font-mono text-gray-500 hover:text-gray-300 border border-gray-800 hover:border-gray-600 px-4 py-2 transition-colors">
    ...
    <html lang="en" class="dark">
      ...
      <body class="bg-gray-950 text-gray-100 min-h-screen flex items-center justify-center">
        <main class="text-center max-w-md border border-gray-800 bg-gray-950 p-8 rounded-lg">
          ...
          <p class="mt-4 text-sm text-gray-400 font-mono">An internal error has occurred. The system has been notified.</p>
          <a href="/" class="mt-6 inline-block text-xs font-mono text-gray-500 hover:text-gray-300 border border-gray-800 hover:border-gray-600 px-4 py-2 transition-colors">
            Return to the ledger
          </a>
        </main>
